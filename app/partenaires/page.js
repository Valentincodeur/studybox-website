      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            {/* PARTENAIRE 9 - Swish Nation */}
            <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] border border-gray-100">
              <div className="h-72 bg-white flex items-center justify-center p-12">
                <Image 
                  src="/images/logo swish nation.png" 
                  alt="Swish Nation" 
                  width={350} 
                  height={175} 
                  className="w-3/5 h-auto object-contain"
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold text-black mb-2">Swish Nation</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  Organisation de stages de basketball pour jeunes avec coaches diplômés et matériel de pointe.
                </p>
                ...
                <div className="space-y-3 mb-6 pb-6 border-b border-gray-100">
                  <div className="flex items-start">
                    ...
                    <span className="text-sm text-gray-600">swishbrussels@gmail.com</span>
                  </div>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 mr-3 text-gray-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span className="text-sm text-gray-600">Stages de basketball</span>
                  </div>
                </div>
                
                <a href="https://www.swishnation.be" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-semibold text-sm hover:underline inline-flex items-center">
                  Visiter le site
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
